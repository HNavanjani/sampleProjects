...
<div class="row">
<a href="" class="btn btn-success" style="margin-left:82%" data-toggle="modal" data-target="#exampleModal">Add New Student</a>
<div class="col-md-12">
...
<td>
<!---------------------------------------SHOW BUTTON CODE STARTS HERE---------------------------------------------------------------------------------------------------------------->
<a data-student_id="{{$student->id}}" data-firstname="{{$student->firstname}}" data-lastname="{{$student->lastname}}" 
data-gender="{{$student->gender}}" data-country="{{$student->country}}" data-city="{{$student->city}}" data-address="{{$student->address}}" 
data-toggle="modal" data-target="#exampleModal-show" type="button" class="btn btn-warning btn-sm">Show</a>
<!---------------------------------------SHOW BUTTON CODE ENDS HERE---------------------------------------------------------------------------------------------------------------->

<!---------------------------------------EDIT BUTTON CODE STARTS HERE---------------------------------------------------------------------------------------------------------------->
<a data-student_id="{{$student->id}}" data-firstname="{{$student->firstname}}" data-lastname="{{$student->lastname}}" 
data-gender="{{$student->gender}}" data-country="{{$student->country}}" data-city="{{$student->city}}" data-address="{{$student->address}}" 
data-toggle="modal" data-target="#exampleModal-edit" type="button" class="btn btn-info btn-sm">Edit</a>
...
<input type="text" readonly class="form-control" id="firstname"  name="firstname" placeholder="Enter First Name">
<input type="text" readonly class="form-control" id="lastname" name="lastname" placeholder="Enter Last Name">
</div>
<input type="hidden" id="student_id" name="student_id">
<br/>
<div class="input-group">
...
<input type="text" readonly class="form-control" id="country" name="country" placeholder="Enter Country Name">
<input type="text" readonly class="form-control"  id="city" name="city" placeholder="Enter City Name">
</div>
<br/>
<div class="input-group">
<div class="input-group-prepend">
...
<textarea type="text" readonly class="form-control" id="address" name="address" placeholder="Enter Address"></textarea>
<input type="text" readonly class="form-control" id="gender" name="gender" placeholder="Enter Gender">
</div>
<br/>
</div>
      <div class="modal-footer">
